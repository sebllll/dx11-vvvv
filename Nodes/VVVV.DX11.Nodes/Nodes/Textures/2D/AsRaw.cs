...
{
    [PluginInfo(Name = "AsRaw", Category = "DX11.Texture", Version = "2d", Author = "vux", AutoEvaluate = true)]
    public class AsRawTextureNode : IPluginEvaluate, IDX11ResourceDataRetriever
    {
        [Input("Texture In")]
        ...
        //[Output("Output")]
        //protected ISpread<string> FOutputd;
